...
const Videos = () => {
  ...
  useEffect(() => {
    ...
    .then(data => {
        ...
        setToday(data.daily.time[1])
        setTodayMaximumTemperature(data.daily.temperature_2m_max[1])
        setTodayMinimumTemperature(data.daily.temperature_2m_min[1])
        setWeatherCode(getWeather(data.daily.weathercode[1]))
    })
},[])
